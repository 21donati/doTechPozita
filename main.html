...
<head>
    ...
    <link rel="stylesheet" href="ngushti.css">
...
<body>
    ...
    <div class="main-one">
        <div class="main-one-left">
            <div>
                <p class="title">Connecting Talent - Building Our Future</p>
                <p class="first-des">Techpozita helps jobseekers find their next work opportunity, and recruiters <br> by finding talent for their venture</p>
            </div>
            <div>
                <button class="work">Looking for work?</button>
                <button class="hire">Looking for a hire?</button>
            </div>
        </div >
    ...
    <div class="stats">
        <div class="statsOne">
            <p class="titleStats">12K+</p>
            <p class="first-desStats">Tech Jobs</p>
        </div>
        <div class="statsTwo">
            <p class="titleStats">130K+</p>
            <p class="second-desStats">Ready Candidates</p>
        </div>
        <div class="statsThree">
            <p class="titleStats">5K+</p>
            <p class="third-desStats">Companies</p>
        </div>
    </div>
    ...
    <div class="mainSecond">
        ...
        <div class="mainSecond-right">
            ...
            <p class="mainSecond-thirdDes">Unique jobs at <span class="mainSecond-blueText">startups</span> and <span class="mainSecond-blueText">startups</span> you can't find anywhere else</p>
            <p class="mainSecond-fourthDes">Say goodbye to cover letters - your profile is all you need. <span class="mainSecond-blueText">One click to apply</span class="mainSecond-blueText"> and you're done.</p>
    ...
    <div class="mainSecond2">
        <div class="mainSecond-left">
            <p class="mainSecond-firstDes">Got talent?</p>
            <p class="mainSecond-secondDes">Why recruiters work with us</p>
            <p class="mainSecond-thirdDes"><span class="mainSecond-blueText">Over 130,000</span> responsive and startup-ready candidates, with all the information you need to vet them</p>
            <p class="mainSecond-fourthDes">Everything you need to kickstart your recruiting - get job posts, company branding, and HR tools set up <span class="mainSecond-blueText">within 10 minutes, for free!</span></p>
    ...
    <div class="secondNgushti">
        <p class="secondNgushti1">Don't just take it from us</p>
        <p class="secondNgushti2">From the community</p>
    </div>
    ...
    <div class="footer">
        ...
        <div class="footer2">
            ...
            <p class="footer2-comp">For Recruiters</p>
            <p class="footer2-comp">Blog</p>
            <p class="footer2-comp">For Jobseekers</p>
            <p class="footer2-comp">Log in</p>
            <p class="footer2-comp">Sign Up</p>
        </div>
        <div class="footer3">
        ...
        <div class="footer4">
            <p class="footer2-title">Subscribe to our Newsletter </p>
            <input type="email" placeholder="Your email..." class="footer-email">

...
<body>
    <div class="navBar">
        ...
        <div class="center-navBar">
            <a href="home.html"><button class="navButtons">Home</button></a>
    ...
    <div class="main-one">
        <div class="main-one-left">
            <div>
                <p class="title">You have a job. We have 130K+ job seekers.</p>
                <p class="first-des">130,000 startup-ready candidates from around the world, unique details you can't find anywhere else, and all the tools you need to hire. Get started for free. </p>
            </div>
            <div>
                <a href="createAccount.html"><button class="work">Sign up now</button></a>
            </div>
        </div >
        <div class="main-one-right">
            <img src="/photos/undraw_business_decisions_re_84ag 1.svg" class="first-main-photo">
        </div>
    </div>

    <div class="ngushti">
        <input type="email" placeholder="Your email" class="your-email">
        <a href="/createAccount.html"><button class="sign-up-two">Sign Up</button></a>
        <p class="or">or</p>
